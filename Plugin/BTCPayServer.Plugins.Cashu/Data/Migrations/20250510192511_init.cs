...
namespace BTCPayServer.Plugins.Cashu.Data.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "BTCPayServer.Plugins.Cashu");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeltDetails_Expiry = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    MeltDetails_LightningInvoiceId = table.Column<string>(
                        type: "text",
                        nullable: true
                    ),
                    MeltDetails_Status = table.Column<string>(type: "text", nullable: true),
                    RetryCount = table.Column<int>(type: "integer", nullable: false),
                    LastRetried = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new
                        {
                            x.FailedTransactionInvoiceId,
                            x.FailedTransactionMintUrl,
                        },
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "MintKeys", schema: "BTCPayServer.Plugins.Cashu");

            migrationBuilder.DropTable(name: "Proofs", schema: "BTCPayServer.Plugins.Cashu");

            migrationBuilder.DropTable(name: "Mints", schema: "BTCPayServer.Plugins.Cashu");
